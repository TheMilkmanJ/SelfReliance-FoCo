...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    color: '#3949AB',
    blurb: 'Switch English, Spanish, Hindi, Chinese, Vietnamese, Korean, Arabic, or Hebrew, plus interpreters and English classes.',
  },
  {
    id: 'religion',
    ...
    color: '#4A148C',
    blurb: 'Jewish, Christian, Muslim, Hindu, Buddhist, Sikh, and interfaith desks. Church pantries stay on Food and Clothes.',
  },
  {
    id: 'voting',
    label: 'Voters',
  ...
  },
  {
    ...
    icon: 'rose-outline',
    color: '#AD1457',
    blurb: 'Marriage and civil union licenses, a certified copy after the ceremony, then Social Security and DMV if you change your name.',
  },
  {
    id: 'divorce',
    label: 'Divorce',
    ...
    color: '#4E342E',
    blurb: 'Court forms, free legal help if you qualify, child support, and a crisis line if you need to leave safely.',
  },
  {
    id: 'veterans',
    label: 'Veterans',
