...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.5%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.5</strong> (language list scrolls in the dropdown, Faith & religion tile, Hebrew menus). About 71 MB. Installs over any earlier FoCo build (versionCode 38).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.5** / versionCode **38**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.5 APK needs that same key and versionCode 39+.
...
## What is in the app (v2.24.5, versionCode 38)
...
```
bcc231bad838549f379a20e9988aa827420d4092ed16a4cc6bce99a1470bc81d
```
