...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.17.0%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.17.0</strong> (Give, need, volunteer on Resources home). About 71 MB. Installs over any earlier FoCo build (versionCode 23).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.17.0** / versionCode **23**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.17.0 APK needs that same key and versionCode 24+.
...
**Already have Self-Reliance FoCo?** Install this over it. Same app, same key. If the bottom tabs still say Jobs, Housing, and Clothes, you still have v2.6.0 or older — delete the old APK from Downloads and grab v2.17.0 again. If Clothes only shows three cards, you are on v2.13.x or older — install this over it. If there is no Trash day card on Resources home, you are on v2.14.0 or older. If there is no Offline maps card, you are on v2.15.0 or older. If there is no Give, need, volunteer card, you are on v2.16.0 or older.
...
## What is in the app (v2.17.0, versionCode 23)
...
- **Trash day** (Resources home): Fort Collins city-contracted homes pick a usual Republic weekday. The phone remembers it and delays one day for the six observed weekday holidays. Carts out by 7am. Recycling same day. Yard trimmings April–November. Look up the address on Republic or call 970-416-2012. Loveland has Recollect plus a recycling-week switch. Estes Park, Berthoud, and Wellington show hauler numbers.
...
To verify the published APK: `sha256 9eb3a1117af776741acc446a9d5f1b5f30ac080c7ae45f4ad574b95f3df14675`
