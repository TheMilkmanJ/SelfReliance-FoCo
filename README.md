...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.8%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.8</strong> (Trash day: East of College around Horsetooth is Tuesday — leftover Friday from another neighborhood does not say Out today. Cart rows say Tuesday, or Out today on the real pickup day). About 71 MB. Installs over any earlier FoCo build (versionCode 41).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.8** / versionCode **41**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.8 APK needs that same key and versionCode 42+.
...
## What is in the app (v2.24.8, versionCode 41)
...
```
a5b97ead071b4adf651feb752d81b0a9cb48fb852da8d3d56f6c56e1643121e5
```
