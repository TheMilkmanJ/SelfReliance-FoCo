...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.15.0%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.15.0</strong> (trash day + open now on Resources home). About 41 MB. Installs over any earlier FoCo build (versionCode 21).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.15.0** / versionCode **21**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.15.0 APK needs that same key and versionCode 22+.
...
**Already have Self-Reliance FoCo?** Install this over it. Same app, same key. If the bottom tabs still say Jobs, Housing, and Clothes, you still have v2.6.0 or older — delete the old APK from Downloads and grab v2.15.0 again. If Clothes only shows three cards, you are on v2.13.x or older — install this over it. If there is no Trash day card on Resources home, you are on v2.14.0 or older.
...
## What is in the app (v2.15.0, versionCode 21)
...
To verify the published APK: `sha256 d6e0465864d0cb382895f529d2b003230305ebe263e642334659f7f7888ebd46`
