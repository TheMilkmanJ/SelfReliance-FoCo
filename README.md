...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.4%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.4</strong> (Faith & religion tile, Hebrew menus). About 71 MB. Installs over any earlier FoCo build (versionCode 37).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.4** / versionCode **37**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.4 APK needs that same key and versionCode 38+.
...
## What is in the app (v2.24.4, versionCode 37)
...
- **Dark mode:** tap the moon (or sun) in the top-right of the header. **Language:** use the dropdown next to it (English, Español, हिन्दी, 中文, Tiếng Việt, 한국어, العربية, עברית) or the same dropdown on the **Language** tile. English classes / Spanish help chips on that tile filter listings; they are not the app-language menu. Colorado ballots still do not include Hebrew.
...
```
bdcce929dfb9b8b356c138a6a2742e7fdf9bee359271e95f46da9db0f5496b9a
```
