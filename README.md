...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.2%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.2</strong> (Hindi, Chinese, Vietnamese, Korean, and Arabic menus too). About 71 MB. Installs over any earlier FoCo build (versionCode 35).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.2** / versionCode **35**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.2 APK needs that same key and versionCode 36+.
...
- **Dark mode:** tap the moon (or sun) in the top-right of the header. **Language:** tap the code next to it (it shows the language you are in) and pick from the list, or use the dropdown on the **Language** tile.
...
npm run check:i18n        # English/Spanish/Hindi/Chinese/Vietnamese/Korean/Arabic keys match
```
...
```
6ae85d47e409564e1ff28342a2fdc18e7e438ddd133dc565806d57a8cf54872c
```
