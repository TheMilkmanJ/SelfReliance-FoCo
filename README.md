...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.1%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.1</strong> (Hindi, Chinese, Vietnamese, Korean, and Arabic menus too). About 71 MB. Installs over any earlier FoCo build (versionCode 34).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.1** / versionCode **34**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.1 APK needs that same key and versionCode 35+.
...
## What is in the app (v2.24.1, versionCode 34)
...
```
7c86aa6f40931c10cdae3230fbd87b0a7ee97bb16b6a42f03d68725ee1e9d595
```
