...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.9%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.9</strong> (Trash day: East of College around Horsetooth is Tuesday. The Friday chip is gone after you pick a mapped neighborhood, so it cannot say Out today on Friday). About 71 MB. Installs over any earlier FoCo build (versionCode 42).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.9** / versionCode **42**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.9 APK needs that same key and versionCode 43+.
...
## What is in the app (v2.24.9, versionCode 42)
...
```
c83f46422ff41b432a742468038d5cb8dddc8b7b659046e982fb8175b442f833
```
