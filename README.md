...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.10%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.10</strong> (Trash day: Horsetooth is Tuesday — the big card says Usual pickup, not Not today. Out today / Carts go out today only on that neighborhood’s real pickup day). About 71 MB. Installs over any earlier FoCo build (versionCode 43).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.10** / versionCode **43**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.10 APK needs that same key and versionCode 44+.
...
## What is in the app (v2.24.10, versionCode 43)
...
```
2dce08d035483a22735254e4fca74317d6c02dfa54f72f0d63a20717dbd30028
```
