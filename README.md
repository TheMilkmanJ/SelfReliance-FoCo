...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.6%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.6</strong> (swipe back from a listing or category returns to the previous screen; the app only exits from Resources home). About 71 MB. Installs over any earlier FoCo build (versionCode 39).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.6** / versionCode **39**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.6 APK needs that same key and versionCode 40+.
...
## What is in the app (v2.24.6, versionCode 39)
...
```
ae502270b0dce8aab1875e626e388f3fd7a9c0cd751cb197f712058e7d0dac87
```
