...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.7%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.7</strong> (Trash day shows the weekday in large type — Goes out Friday, or Friday · out today). About 71 MB. Installs over any earlier FoCo build (versionCode 40).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.7** / versionCode **40**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.7 APK needs that same key and versionCode 41+.
...
## What is in the app (v2.24.7, versionCode 40)
...
```
b83bdd797b5302eb849ebaadb40885e6d2b8dc57e11532c886d71bdf64e66ad6
```
