...
<p align="center"><strong>Current download: v2.24.12</strong> (Wellington Public Library, Berthoud Community Library, and Larimer County Jail visiting). About 71 MB. Installs over any earlier FoCo build (versionCode 45).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.12** / versionCode **45**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.12 APK needs that same key and versionCode 46+.
...
```
d514bdd8a550cd02f5df2d28bef06ade2306b0b93d2812c15d46e1fc27fe9687
```
