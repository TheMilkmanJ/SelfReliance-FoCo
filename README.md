...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.22.0%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.22.0</strong> (Trash day regions + Early Head Start). About 71 MB. Installs over any earlier FoCo build (versionCode 28).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.22.0** / versionCode **28**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.22.0 APK needs that same key and versionCode 29+.
...
**Already have Self-Reliance FoCo?** Install this over it. Same app, same key. If the bottom tabs still say Jobs, Housing, and Clothes, you still have v2.6.0 or older — delete the old APK from Downloads and grab v2.22.0 again. If Clothes only shows three cards, you are on v2.13.x or older — install this over it. If there is no Trash day card on Resources home, you are on v2.14.0 or older. If there is no Offline maps card, you are on v2.15.0 or older. If there is no Give, need, volunteer card, you are on v2.16.0 or older. If Trash day has weekday chips but no Highlander Heights dropdown, you are on v2.18.0 or older. If there is no **Pregnancy & Birth** tile, you are on v2.19.0 or older. If there is no **Voters** tile, you are on v2.20.0 or older. If Trash day only lists Fort Collins neighborhoods, you are on v2.21.0 or older.
...
## What is in the app (v2.22.0, versionCode 28)
...
- **Trash day** (Resources home): One dropdown lists trash-day regions for Fort Collins, Loveland, Estes Park, Berthoud, Wellington, and unincorporated Larimer. **Highlander Heights is Friday** on Republic’s 2026 map. Loveland neighborhoods (Centerra, Campion, Namaqua, downtown) are listed; the weekday comes from Recollect — this app does not invent Loveland days. Estes, Berthoud, and Wellington list neighborhoods or licensed haulers; pickup day is on the bill. Unincorporated Larimer has no county curbside route (landfill self-haul or a private hauler). Trash cart, recycling, and yard trimmings sit in the same row style as Call / Look up. The phone remembers the region and delays Fort Collins Republic routes one day for the six observed weekday holidays. Carts out by 7am in FoCo. Extra-small trash carts are every other week; recycling is still weekly.
...
`sha256: 95a51b723ef6c9f89e07122f991599046536a00c9f0c44c06f1e87a67f97dcd8`
