...
<p align="center">
  <a href="https://github.com/TheMilkmanJ/SelfReliance-FoCo/releases/latest/download/Self-Reliance-FoCo.apk"><img alt="Download the Android app" src="https://img.shields.io/badge/Download%20v2.24.0%20for%20Android-Self--Reliance--FoCo.apk-522f81?style=for-the-badge&logo=android&logoColor=white" /></a>
  <br />
...
<p align="center"><strong>Current download: v2.24.0</strong> (Hindi, Chinese, Vietnamese, Korean, and Arabic menus too). About 71 MB. Installs over any earlier FoCo build (versionCode 33).</p>
...
- App config (name, Android package `org.foco.selfreliance`, version **2.24.0** / versionCode **33**): [`app.json`](app.json)
- License: [MIT](LICENSE)
...
The release keystore is **not** in this repo. Anyone can build a debug APK. A Play-style upgrade over the public v2.24.0 APK needs that same key and versionCode 34+.
...
- **Dark mode:** tap the moon (or sun) in the top-right of the header. **Language:** tap the code next to it (EN, ES, HI, ZH, VI, KO, AR), or open the **Language** tile.
...
To verify the published APK: `sha256sum` pending release build.
